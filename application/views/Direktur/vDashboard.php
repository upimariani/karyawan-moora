			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="callout callout-success">
						...
						<p>Pada Karyawan atas nama <strong><?= $dashboard['karyawan_terbaik']->nama_karyawan ?></strong> Posisi. <strong><?= $dashboard['karyawan_terbaik']->divisi ?></strong> sebagai <strong><?= $dashboard['karyawan_terbaik']->jabatan ?></strong></p>
					</div>
					<!-- /.card -->
				</div>
				<!-- /.col -->
