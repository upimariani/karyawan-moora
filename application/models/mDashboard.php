...
class mDashboard extends CI_Model
{
	public function dashboard()
	{
		...
		$data['karyawan_terbaik'] = $this->db->query("SELECT * FROM `tbl_penilaian` JOIN tbl_karyawan ON tbl_karyawan.id_karyawan=tbl_penilaian.id_karyawan ORDER BY hasil DESC LIMIT 1")->row();
		return $data;
	}
}
